...
/** This is a REST controller for MenuItemReviw */
...
public class MenuItemReviewController extends ApiController {
   ...
   * @param stars the star rating from 0 to 5
   * @param dateReviewed the day that the review is submitted
   * @param comments the comments left by the reviewer
