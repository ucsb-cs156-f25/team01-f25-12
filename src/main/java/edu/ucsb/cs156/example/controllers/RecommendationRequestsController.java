...
public class RecommendationRequestsController extends ApiController {
   ...
   * @param professorEmail the email of the giver (professor)
   * @param explanation the reason for requesting the recommendation
   * @param dateRequested the date it was requested
   * @param dateNeeded the date it is needed by
   * @param done if it is completed
  ...
  public RecommendationRequest postRecommendationRequest(
    ...
    log.info(
        "Creating recommendation request for requesterEmail={} and professorEmail={}",
        requesterEmail,
        professorEmail);
